...
import static com.wf.blog.consts.ViewConsts.VIEW_MSG;
...
public class UserController extends BaseController {
	...
	public String fFrontUserLogin(HttpServletRequest request, Model model,
			@Valid UserLoginForm loginForm, BindingResult bindingResult)
			throws Exception {
	...
	public String fFrontUserRegister(@Valid UserRegisterForm registerForm,
