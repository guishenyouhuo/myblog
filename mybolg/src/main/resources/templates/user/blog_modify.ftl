...
<head>
    ...
    <!-- EditorMD -->
    <link rel="stylesheet" href="${basePath}/vendor/editor/css/editormd.css"/>
...
<script src="${basePath}/vendor/editor/editormd.min.js"></script>

<#-- 自定义 js -->
<script src="${basePath}/js/user/b_blog_modify.js"></script>
